...
function MgrDash({user,onLogout,D,A,syncing,offlineMode,offlineQueueCount}){
  const mgrTabs=["overview","inbox","orders","planner","pos","rfqs","reports","billing","invoices","feedback","agreements","equipment","team","customers","users","calendar","projects","kb","guide"];
...
function AdminDash({user,onLogout,D,A,syncing,offlineMode,offlineQueueCount}){
  const adminTabs=["overview","inbox","orders","planner","pos","rfqs","reports","billing","invoices","feedback","proposals","agreements","recurring","equipment","customers","users","settings","calendar","projects","kb","guide"];
