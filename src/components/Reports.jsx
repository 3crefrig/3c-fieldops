...
function Reports({wos,pos,timeEntries,users,customers,invoices}){
  ...
  return(<div>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16,flexWrap:"wrap",gap:8}}>
      <div style={{display:"flex",alignItems:"center",gap:10}}><h3 style={{margin:0,fontSize:15,fontWeight:600,color:B.text}}>Reports & KPIs</h3><button data-tip="Download this period as a spreadsheet — one row per completed job with hours and PO spend." onClick={exportCSV} style={{...BS,padding:"5px 12px",fontSize:11}}>Export CSV</button><button data-tip="A one-page PDF summary of this period — handy for meetings." onClick={exportPDF} style={{...BS,padding:"5px 12px",fontSize:11}}>Export PDF</button></div>
