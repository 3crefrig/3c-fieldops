...
function App(){
  ...
  const loadData=useCallback(async()=>{try{const client=sb();if(!client)return;
    const[wos,pos,time,photos,users,appSettingsRows,templates,notifs,customers,emailTemplates,projects,woDrafts,invoices,feedbackData,equipmentData,agreementsData,agreementTiersData,lineItemsData,rfqsData,rfqItemsData,rfqSpecsData,poTicketsData,poTicketItemsData,vendorBillsData,vendorBillItemsData]=await Promise.all([
    ...
    [wos,pos,time,photos,users,appSettingsRows,templates,notifs,customers,emailTemplates,projects,woDrafts,invoices,feedbackData,equipmentData,agreementsData,agreementTiersData,lineItemsData,rfqsData,rfqItemsData,rfqSpecsData,poTicketsData,poTicketItemsData,vendorBillsData,vendorBillItemsData].forEach((r,i)=>{if(r.error)console.warn("loadData query "+i+" failed:",r.error.message);});
