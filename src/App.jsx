...
function App(){
  ...
  const actions={
    ...
    addUser:withTableSync("users",async(u)=>{const{error}=await sb().from("users").insert(u);if(error){alert("Failed to add user.");throw error;}}),
